import { Check, Target } from "phosphor-react";
...
export function NewHabitsforms() {
    ...
    function hangleToggleWeekDays(weekDay: number,) {
    ...
    return (
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
            ...
            <input
                ...
                className="p-4 rounded-lg mt-3 bg-zinc-800 text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-zinc-900"
                autoFocus
                value={title}
                ...
                {avaliableWeekDays.map((weekDay, index) => {
                    return (
                        <CheckBox.Root
                            ...
                            onCheckedChange={() => hangleToggleWeekDays(index)}>
